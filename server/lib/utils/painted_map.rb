class Utils::PaintedMap
  ...
  def self.parse(value)
    value = normalize_painted_map(value)
  ...
  def self.check_size_of_two_dim_array?(array)
    ...
    (array.count { |a| a.size == ARRAY_SIZE } == ARRAY_SIZE)
  end

  def self.check_only0or1_in_array?(array)
    array.flatten.count do |a|
      (a == 0) || (a == 1)
