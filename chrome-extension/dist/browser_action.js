...
/***/ function(module, exports, __webpack_require__) {
	...
	var PaintModeButtonGroup = (function (_React$Component) {
	  _inherits(PaintModeButtonGroup, _React$Component);

	  function PaintModeButtonGroup(props) {
	    _classCallCheck(this, PaintModeButtonGroup);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PaintModeButtonGroup).call(this, props));
	  ...
	  _createClass(PaintModeButtonGroup, [{
	    key: "setModePaint",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeaponButtonGroup = (function (_React$Component) {
	  _inherits(WeaponButtonGroup, _React$Component);

	  function WeaponButtonGroup(props) {
	    _classCallCheck(this, WeaponButtonGroup);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(WeaponButtonGroup).call(this, props));
	  ...
	  _createClass(WeaponButtonGroup, [{
	    key: "useSushikora",
	    value: function useSushikora() {
	      this.setState({
	        weapon: "sushikora"
	      });
	    }
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "button",
	          { type: "button", onClick: this.useBold.bind(this),
	...
	var PostPaintDataButton = (function (_React$Component) {
	  ...
	  _createClass(PostPaintDataButton, [{
	    ...
	    value: function postPaintData() {
	      ...
	      $("#loading").attr("src", "images/loading.gif").fadeIn(100);
	      ...
	      $.ajax({
	        ...
	        error: function error(err) {
	          console.log(err);
	          $("#loading").attr("src", "images/failer.png");
	          $("#post-message").css("color", "red").text("送信に失敗しました").fadeIn(100);
	        }
	      });
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeaponButtonGroup = __webpack_require__(160);
	var PostPaintDataButton = __webpack_require__(161);
	  ...
	  _createClass(MainForm, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(WeaponButtonGroup, { weapon: init_weapon }),
	        ...
	        _react2.default.createElement("img", { id: "loading", height: "20px",
